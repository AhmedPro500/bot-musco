...
client.on('ready', () => {
  ...
  console.log('')
   ...
   client.on('message', message => {
    const prefix = 'a'
var args = message.content.split("a").slice(1);    
...
client.on('message', message => {
    ...
    client.on('message', message => {
    if(message.content == prefix + 'aservers') {
             if(!message.author.id === '244888652004458497') return;
    var gimg;
    var gname;
    var gmemb;
...
client.on('message', function(message) {
	const myID = "490404894071717930"
    let args = message.content.split(" ").slice(1).join(" ");
    if(message.content.startsWith(prefix + "aasetname")) {
...
:checkered_flag: تاريخ انضمامك للسيرفر ${member.joinedAt.toLocaleString()} :checkered_flag:`) 
  ...
  client.on('message',async message => {
    if(message.content.startsWith(prefix + "restart")) {
        if(message.author.id !== "546878681084198915") return message.reply('You aren\'t the bot owner.');
...
client.on('message', message => {
	var prefix = "a";
if (message.content.startsWith(prefix + 'atag')) {
    let args = message.content.split(" ").slice(1);
...
client.on('message', message => { 
let PREFIX = '*'
    if (message.content.startsWith(PREFIX + 'aemojilist')) {
...
client.on('message', message => {
   ...
   client.on('message', message => {
    ...
    if (message.content.startsWith("alink")) {        
...
client.on('message', eyad => {
  if (eyad.content.startsWith('avb')) {
...
var prefix = "*";
if(omar.content.split(' ')[0] == prefix + 'adc') {  // delete all channels
...
client.on('message', message => {
var prefix = "a";
      if(message.content === prefix + "ahidechannel") {
      if(!message.channel.guild) return;
...
client.on('message', message => {
var prefix = "a";
      if(message.content === prefix + "ashowchannel") {
      if(!message.channel.guild) return;
...
client.on('message', message => {
var prefix = "a";
       if(message.content === prefix + "amutechannel") {
                           if(!message.channel.guild) return message.reply('** This command only for servers**');
...
//FIRE BOT
    if(message.content === prefix + "aunmutechannel") {
                        if(!message.channel.guild) return message.reply('** This command only for servers**');
...
client.on("message", message => {
	...
	if( !message.guild ) return;
	if( !msg.startsWith( prefix + 'arole' ) ) return;
	if(!message.member.hasPermission('aMANAGE_ROLES')) return message.channel.send(' **__ليس لديك صلاحيات__**');
	if( msg.toLowerCase().startsWith( prefix + 'aroleremove' ) ){
		...
		if( args[0].toLowerCase() == "aaall" ){
			message.guild.members.forEach(m=>m.removeRole( role1 ))
			return	message.reply('**:white_check_mark: [ '+role1.name+' ] تم سحب من الكل رتبة**');
		} else if( args[0].toLowerCase() == "abots" ){
			message.guild.members.filter(m=>m.user.bot).forEach(m=>m.removeRole(role1))
			return	message.reply('**:white_check_mark: [ '+role1.name+' ] تم سحب من البوتات رتبة**');
		} else if( args[0].toLowerCase() == "ahumans" ){
			message.guild.members.filter(m=>!m.user.bot).forEach(m=>m.removeRole(role1))
...
client.on('message', message => {
if (message.content.startsWith("aadd.r")) {
...
client.on('message', message =>{
    ...
    if(message.content == "aroles"){
        var 
        ros=message.guild.roles.size,
        data = [['aRank', 'aRoleName']]
        for(let i =0;i<ros;i++){
...
client.on('message' , message => {
  var prefix = "a";
  if(message.author.bot) return;
  if(message.content.startsWith(prefix + "abcrole")) {
    let args = message.content.split(" ").slice(1);
    ...
    var prefix = "a";
            ...
            if (message.content.startsWith(prefix + "aclearall")) {
...
if (message.content.startsWith("*ct")) {
        ...
        let args = message.content.split(" ").slice(1);
    message.guild.createChannel(args.join(' '), 'atext');
...
if (message.content.startsWith("*cv")) {
	...
	client.on("message", (message) => {
    if (message.content.startsWith('*adelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
...
client.on('message', x5bz => {   
 if (x5bz.content.startsWith("*adeletall")) {
...
client.on('message', message => {
  ...
  message.channel.send({
    embed : kickembed
        ...
        client.on('message', message => {
                        let args = message.content.split(" ").slice(1).join(" ")
if(message.content.startsWith(prefix + 'acolor')) {
	...
	client.on('message', message => {
if(message.content.startsWith(prefix + 'amove all')) {
...
if (message.member.voiceChannel == null) return message.channel.send(`**الرجاء الدخول لروم صوتي**`)
 ...
 message.channel.send(`**تم سحب جميع الأعضاء إليك**`)
	   ...
	   client.on("amessage", message => {
 if (message.content === "agames") {
        message.react("📫")
	           message.react("✅")
  const embed = new Discord.RichEmbed() 
      .setColor("#8325c0")
  ...
  message.channel.send({
    ...
    client.log.error(e);
	  ...
	  client.on('message', message => {
        ...
        if(message.content.startsWith(prefix + "aroll")){
...
client.on('message' , async (message) => {
       if(message.content.startsWith(prefix + "aarps")) {
              let args = message.content.split(" ").slice(1);
  var choice = args[0];
  if (choice == "ورقة" || choice == "aap") {
...
const codes = {
  ...
  client.on('message' , async message => {
         if(message.content.startsWith(prefix + "aemoji")) {
            let args = message.content.split(" ").slice(1);
    if (args.length < 1) {
